...
},{"socket.io-client/dist/socket.io":"bvVR2","jquery":"hgMhh","bootstrap/dist/css/bootstrap.min.css":"i5LP7"}],"bvVR2":[function(require,module,exports) {
/*!
 * Socket.IO v4.4.1
 ...
 */ (function(global, factory) {
   ...
   */ var chars = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'; // Use a lookup table to find the index.
    ...
    var protocol$1 = 4;
    var Transport1 = /*#__PURE__*/ function(_Emitter) {
    ...
    var alphabet = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_'.split(''), length1 = 64, map = {}, seed = 0, i1 = 0, prev;
    /**
   ...
   */ function encode(num) {
        var encoded = '';
        do {
            encoded = alphabet[num % length1] + encoded;
            num = Math.floor(num / length1);
        }while (num > 0)
        return encoded;
    }
    /**
   ...
   */ function decode(str) {
        var decoded = 0;
        for(i1 = 0; i1 < str.length; i1++)decoded = decoded * length1 + map[str.charAt(i1)];
        return decoded;
    }
    /**
   ...
   */ function yeast() {
    ...
    //
    for(; i1 < length1; i1++)map[alphabet[i1]] = i1;
     //
   ...
   */ parseqs.decode = function(qs) {
    ...
    var Polling1 = /*#__PURE__*/ function(_Transport) {
     ...
     */ _createClass(Polling, [
            ...
            },
            {
                ...
                value: function uri() {
                    ...
                    if (false !== this.opts.timestampRequests) query[this.opts.timestampParam] = yeast_1();
   ...
   */ function empty() {}
    ...
    var XHR1 = /*#__PURE__*/ function(_Polling) {
    ...
    var Request1 = /*#__PURE__*/ function(_Emitter) {
                ...
                value: function create() {
                    ...
                    try {
                        ...
                        xhr.onreadystatechange = function() {
                            ...
                            if (200 === xhr.status || 1223 === xhr.status) _this5.onLoad();
   ...
   */ if (typeof document !== "undefined") {
    ...
    function unloadHandler() {
        for(var i in Request1.requests)if (Request1.requests.hasOwnProperty(i)) Request1.requests[i].abort();
    }
    ...
    var WS1 = /*#__PURE__*/ function(_Transport) {
     ...
     */ _createClass(WS, [
            ...
            },
            {
                ...
                value: function write(packets) {
                    ...
                    for(var i2 = 0; i2 < packets.length; i2++)_loop(i2);
                }
            },
            {
                key: "doClose",
     ...
     */ function Socket(uri) {
            ...
            if (typeof _this.opts.query === "string") _this.opts.query = parseqs.decode(_this.opts.query);
             // set on handshake
            _this.id = null;
            _this.upgrades = null;
     ...
     */ _createClass(Socket, [
            ...
            },
            {
                ...
                value: function close() {
                    ...
                    var cleanupAndClose1 = function cleanupAndClose() {
                    ...
                    var waitForUpgrade = function waitForUpgrade() {
                        ...
                        _this6.once("upgrade", cleanupAndClose1);
                        _this6.once("upgradeError", cleanupAndClose1);
                    };
                    if ("opening" === this.readyState || "open" === this.readyState) {
   ...
   */ function deconstructPacket(packet) {
    ...
    function _deconstructPacket(data, buffers) {
        ...
        if (isBinary(data)) {
            ...
            var _newData = {};
            for(var key in data)if (data.hasOwnProperty(key)) _newData[key] = _deconstructPacket(data[key], buffers);
            return _newData;
        }
        return data;
    }
   ...
   */ function reconstructPacket(packet, buffers) {
    ...
    function _reconstructPacket(data, buffers) {
        ...
        if (data && data._placeholder) return buffers[data.num]; // appropriate buffer (should be natural order anyway)
            ...
            for(var key in data)if (data.hasOwnProperty(key)) data[key] = _reconstructPacket(data[key], buffers);
        }
        return data;
    }
    /**
   ...
   */ var Encoder1 = /*#__PURE__*/ function() {
        function Encoder() {
       ...
       */ function encode(obj) {
                    if (obj.type === PacketType1.EVENT || obj.type === PacketType1.ACK) {
                        if (hasBinary(obj)) {
                            obj.type = obj.type === PacketType1.EVENT ? PacketType1.BINARY_EVENT : PacketType1.BINARY_ACK;
            ...
            },
            {
                ...
                value: function encodeAsString(obj) {
                    ...
                    if (obj.type === PacketType1.BINARY_EVENT || obj.type === PacketType1.BINARY_ACK) str += obj.attachments + "-";
   ...
   */ var Decoder1 = /*#__PURE__*/ function(_Emitter) {
     ...
     */ _createClass(Decoder, [
            {
                ...
                value: function add(obj) {
                    ...
                    if (typeof obj === "string") {
                        ...
                        if (packet.type === PacketType1.BINARY_EVENT || packet.type === PacketType1.BINARY_ACK) {
                            // binary packet's json
                            this.reconstructor = new BinaryReconstructor1(packet); // no attachments, labeled binary but no binary data to follow
            ...
            },
            {
                ...
                value: function decodeString(str) {
                    ...
                    if (PacketType1[p.type] === undefined) throw new Error("unknown packet type " + p.type);
   ...
   */ var BinaryReconstructor1 = /*#__PURE__*/ function() {
   ...
   */ var RESERVED_EVENTS = Object.freeze({
    ...
    var Socket1 = /*#__PURE__*/ function(_Emitter) {
        _inherits(Socket, _Emitter);
        var _super = _createSuper(Socket);
        /**
     * `Socket` constructor.
     ...
     */ _createClass(Socket, [
            {
                ...
                value: function subEvents() {
                    ...
                    var io = this.io;
                    this.subs = [
                        on1(io, "open", this.onopen.bind(this)),
                        on1(io, "packet", this.onpacket.bind(this)),
                        on1(io, "error", this.onerror.bind(this)),
                        on1(io, "close", this.onclose.bind(this))
                    ];
                }
            },
            {
   ...
   */ Backoff.prototype.setJitter = function(jitter) {
    ...
    var Manager1 = /*#__PURE__*/ function(_Emitter) {
        ...
        _createClass(Manager, [
            ...
            },
            {
                ...
                value: function open(fn) {
                    ...
                    var openSubDestroy = on1(socket, "open", function() {
                        self.onopen();
                        fn && fn();
                    }); // emit `error`
                    var errorSub = on1(socket, "error", function(err) {
                        self.cleanup();
            ...
            },
            {
                ...
                value: function onopen() {
                    ...
                    var socket = this.engine;
                    this.subs.push(on1(socket, "ping", this.onping.bind(this)), on1(socket, "data", this.ondata.bind(this)), on1(socket, "error", this.onerror.bind(this)), on1(socket, "close", this.onclose.bind(this)), on1(this.decoder, "decoded", this.ondecoded.bind(this)));
                }
            },
            {
                key: "onping",
            ...
            },
            {
                ...
                value: function socket(nsp, opts) {
                    ...
                    if (!socket) {
                        socket = new Socket1(this, nsp, opts);
   ...
   */ var cache = {};
    function lookup(uri, opts) {
        ...
        var io;
        if (newConnection) io = new Manager1(source, opts);
        else {
            if (!cache[id]) cache[id] = new Manager1(source, opts);
            io = cache[id];
        }
...
},{}],"i5LP7":[function() {},{}]},["6IXwR","bNKaB"], "bNKaB", "parcelRequire6d7c")
